...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public List<Employee> findAllByBirthdayBeforeOrderBySalaryDesc(int year) {
        return this.employeeRepository.findAllByBirthdayBeforeOrderBySalaryDesc(year).orElseThrow(NoSuchElementException::new);
    }
}
